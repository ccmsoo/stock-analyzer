...
## ③ ~~검증으로 확정된 운용 규칙~~ → **미검증 (2026-08-20 감사로 폐기)**

> ⚠️ 아래 항목은 **대조군 없이 지수만 벤치마크로 쓴 수치**라 현재 근거가 없다.
> 같은 날·같은 시장 워치리스트와 비교하면 픽은 오히려 **−2.7%p 열위(t=−6.2)**.
> 상세: [docs/audit_20260820.md](docs/audit_20260820.md) · 재현: `venv/bin/python -m tools.control_test`
> 성과 주장 전에 반드시 대조군 검정을 통과시킬 것. (기록 보존용으로만 아래를 남긴다)

### (참고용 원문) 2026-06-25~07-22, 786픽
